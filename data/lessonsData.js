  ...
  hi: [
    {
      ...
      description: 'ओटीपी स्कैम और नकली सत्यापन कॉल से कैसे बचें और उन्हें कैसे पहचानें।',
      ...
      quiz: [
        {
          id: 'q1',
          question: 'क्या आपको बैंक से आने वाले व्यक्ति के साथ अपना ओटीपी साझा करना चाहिए?',
          options: ['हाँ', 'नहीं'],
          correct: 1
        },
        {
    ...
    },
    {
      ...
      description: 'सामान्य लोन स्कैम रणनीति को समझें और वैध लोन ऑफर को कैसे सत्यापित करें।',
    ...
    },
    {
      ...
      description: 'संदिग्ध टेक्स्ट संदेशों को पहचानें और अपनी व्यक्तिगत जानकारी की सुरक्षा करें।',
      ...
      quiz: [
        ...
        {
          id: 'q2',
          question: 'क्या बैंक आमतौर पर एसएमएस के माध्यम से पासवर्ड मांगते हैं?',
          options: ['हाँ', 'नहीं'],
          correct: 1
        },
        {
  ...
  pa: [
    {
      ...
      description: 'ਸਿੱਖੋ ਕਿ OTP ਠੱਗੀਆਂ ਅਤੇ ਨਕਲੀ ਤਸਦੀਕ ਕਾਲਾਂ ਤੋਂ ਆਪਣੇ ਆਪ ਨੂੰ ਕਿਵੇਂ ਬਚਾਇਆ ਜਾਵੇ।',
      audio: require('../../assets/audio/otp-scam-awareness-pa.mp3'),
      duration: '3:45',
      difficulty: 'ਬਿਗਿਨਰ',
      quiz: [
        { id: 'q1', question: 'ਕੀ ਤੁਹਾਨੂੰ ਆਪਣੇ ਬੈਂਕ ਵੱਲੋਂ ਦਾਅਵਾ ਕਰਨ ਵਾਲੇ ਕਿਸੇ ਨਾਲ ਆਪਣਾ OTP ਸਾਂਝਾ ਕਰਨਾ ਚਾਹੀਦਾ ਹੈ?', options: ['ਹਾਂ', 'ਨਹੀਂ'], correct: 1 },
        { id: 'q2', question: 'ਕੀ ਲੈਣ-ਦੇਣ ਰੱਦ ਕਰਨ ਲਈ OTP ਦੇਣਾ ਸੁਰੱਖਿਅਤ ਹੈ?', options: ['ਹਾਂ', 'ਨਹੀਂ'], correct: 1 },
        { id: 'q3', question: 'ਕੀ ਠੱਗ ਕੇਵਲ ਤੁਹਾਡੇ OTP ਨਾਲ ਪੈਸੇ ਚੁਰੀ ਕਰ ਸਕਦੇ ਹਨ?', options: ['ਹਾਂ', 'ਨਹੀਂ'], correct: 0 }
      ]
    },
    {
      id: 'loan-fraud',
      title: 'ਲੋਨ ਠੱਗੀ ਸੁਰੱਖਿਆ',
      description: 'ਆਮ ਲੋਨ ਠੱਗੀ ਤਰੀਕਿਆਂ ਨੂੰ ਸਮਝੋ ਅਤੇ ਵੈਧ ਲੋਨ ਪੇਸ਼ਕਸ਼ਾਂ ਨੂੰ ਕਿਵੇਂ ਪਛਾਣਣਾ ਹੈ।',
      audio: require('../../assets/audio/loan-fraud-protection-pa.mp3'),
      duration: '4:20',
      difficulty: 'ਇੰਟਰਮੀਡੀਏਟ',
      quiz: [
        { id: 'q1', question: 'ਕੀ ਲੋਨ ਮਨਜ਼ੂਰੀ ਲਈ ਪਹਿਲਾਂ ਤੋਂ ਫੀਸ ਦੇਣੀ ਚਾਹੀਦੀ ਹੈ?', options: ['ਹਾਂ', 'ਨਹੀਂ'], correct: 1 },
        { id: 'q2', question: 'ਕੀ ਬਿਨਾਂ ਦਸਤਾਵੇਜ਼ਾਂ ਦੇ ਤੁਰੰਤ ਲੋਨ ਮਨਜ਼ੂਰੀ ਸ਼ੱਕੀ ਹੁੰਦੀ ਹੈ?', options: ['ਹਾਂ', 'ਨਹੀਂ'], correct: 0 },
        { id: 'q3', question: 'ਕੀ ਲੋਨ ਤਸਦੀਕ ਲਈ ਬੈਂਕ ਵੇਰਵੇ ਸਾਂਝੇ ਕਰਨਾ ਸੁਰੱਖਿਅਤ ਹੈ?', options: ['ਹਾਂ', 'ਨਹੀਂ'], correct: 1 }
      ]
    },
    {
      id: 'phishing-sms',
      title: 'ਫਿਸ਼ਿੰਗ SMS ਪਛਾਣ',
      description: 'ਸ਼ੱਕੀ ਟੈਕਸਟ ਸੁਨੇਹਿਆਂ ਨੂੰ ਪਛਾਣੋ ਅਤੇ ਆਪਣੀ ਨਿੱਜੀ ਜਾਣਕਾਰੀ ਦੀ ਰੱਖਿਆ ਕਰੋ।',
      audio: require('../../assets/audio/phishing-sms-detection-pa.mp3'),
      duration: '2:55',
      difficulty: 'ਬਿਗਿਨਰ',
      quiz: [
        { id: 'q1', question: 'ਕੀ ਤੁਹਾਨੂੰ ਸ਼ੱਕੀ SMS ਸੁਨੇਹਿਆਂ ਵਿੱਚ ਲਿੰਕ ’ਤੇ ਕਲਿੱਕ ਕਰਨਾ ਚਾਹੀਦਾ ਹੈ?', options: ['ਹਾਂ', 'ਨਹੀਂ'], correct: 1 },
        { id: 'q2', question: 'ਕੀ ਬੈਂਕ ਆਮ ਤੌਰ ’ਤੇ SMS ਰਾਹੀਂ ਪਾਸਵਰਡ ਮੰਗਦੇ ਹਨ?', options: ['ਹਾਂ', 'ਨਹੀਂ'], correct: 1 },
        { id: 'q3', question: 'ਕੀ ਤੁਰੰਤ ਕਾਰਵਾਈ ਵਾਲੇ ਸੁਨੇਹੇ ਆਮ ਤੌਰ ’ਤੇ ਠੱਗੀ ਹੁੰਦੇ ਹਨ?', options: ['ਹਾਂ', 'ਨਹੀਂ'], correct: 0 }
      ]
    }
  ]
